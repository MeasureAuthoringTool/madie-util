...
export { default as ChangeVersionAction } from "./actions/changeVersionAction/ChangeVersionAction";
...
export { default as ChangeVersionDialog } from "./dialogs/changeVersionDialog/ChangeVersionDialog";
