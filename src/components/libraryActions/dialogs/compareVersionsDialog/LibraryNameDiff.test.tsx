...
describe("LibraryNameDiff", () => {
  it("renders unchanged text only if no additions or removals", () => {
    render(
      <LibraryNameDiff
        oldLibraryName="Blood Pressure"
        newLibraryName="Blood Pressure"
      />
    );
  ...
  it("renders a simple added token after unchanged text", () => {
    render(
      <LibraryNameDiff
        oldLibraryName="Blood Pressure"
        newLibraryName="Blood Pressure Measurement"
      />
    );
  ...
  it("renders a removed token after unchanged text", () => {
    render(
      <LibraryNameDiff
        oldLibraryName="Blood Pressure Measurement"
        newLibraryName="Blood Pressure"
      />
    );
  ...
  it("adds spaces consistently between unchanged, removed, and added tokens", () => {
    render(
      <LibraryNameDiff
        oldLibraryName="Blood Pressure Measurement"
        newLibraryName="Blood Pressure Updated"
      />
    );
  ...
  it("renders all diff tokens in order with correct content and styling", () => {
    render(
      <LibraryNameDiff
        oldLibraryName="Systolic Blood Pressure"
        newLibraryName="Diastolic Blood Pressure Measurement"
      />
    );
